/****************************************************************************
** Meta object code from reading C++ file 'category.hpp'
**
...
#include <memory>
#include "../../../syllabus/include/category.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'category.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(9, 7), // "getName"
QT_MOC_LITERAL(17, 0), // ""
QT_MOC_LITERAL(18, 11), // "getCategory"
QT_MOC_LITERAL(30, 10), // "getIconUrl"
QT_MOC_LITERAL(41, 12) // "getColorCode"

    },
    "Category\0getName\0\0getCategory\0getIconUrl\0"
    "getColorCode"
};
...
static const uint qt_meta_data_Category[] = {
 ...
 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       1,    0,   38,    2, 0x102,    1 /* Public | MethodIsConst  */,
       3,    0,   39,    2, 0x102,    2 /* Public | MethodIsConst  */,
       4,    0,   40,    2, 0x102,    3 /* Public | MethodIsConst  */,
       5,    0,   41,    2, 0x102,    4 /* Public | MethodIsConst  */,
...
void Category::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->getName(); break;
        case 1: _t->getCategory(); break;
        case 2: _t->getIconUrl(); break;
        case 3: _t->getColorCode(); break;
        default: ;
        }
    }
    (void)_a;
